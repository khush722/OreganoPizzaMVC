...
namespace OreganoPizzaMVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustId,Name,CustomerAddress")] Customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustId,Name,CustomerAddress")] Customers customers)
        {
